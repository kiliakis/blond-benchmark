...
result_dir = result_dir + 'i{}-p{}-t{}-{}-{}-{}/'
csv_dir = csv_dir + 'i{}-p{}-t{}-{}-{}-{}/'

configs = {
    'bench0.exe': {'sizes': [['5000', '4000000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['icc']
                   },
    'bench1.exe': {'sizes': [['5000', '4000000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['icc']
                   },
    'bench3.exe': {'sizes': [['5000', '4000000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['icc']
                   },
    'bench7.exe': {'sizes': [['5000', '4000000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['icc']
