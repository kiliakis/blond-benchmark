...
result_dir = result_dir + 'i{}-p{}-a{}-t{}-{}-{}-{}/'
csv_dir = csv_dir + 'i{}-p{}-a{}-t{}-{}-{}-{}/'

configs = {
    'bench0.exe': {'sizes': [['1000', '4000000', str(x), '1']
                             for x in [0, 1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++', 'icc']},
    'bench1.exe': {'sizes': [['1000', '4000000', str(x), '1']
                             for x in [0, 1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++', 'icc']},
    'bench3.exe': {'sizes': [['1000', '4000000', str(x), '1']
                             for x in [0, 1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++', 'icc']},
