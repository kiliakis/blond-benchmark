...
configs = {
    'bench0': {'sizes': [['500', str(4000 * x), str(4000*c), str(x)]
                        for x in [1, 2, 4, 8, 14, 28, 56]],
              'vec': ['vec', 'novec'],
              'tcm': ['notcm'],
              'cc': ['icc', 'g++']},

    'bench1': {'sizes': [['500', str(4000 * x), str(4000*c), str(x)]
                        for x in [1, 2, 4, 8, 14, 28, 56]],
              'vec': ['vec', 'novec'],
              'tcm': ['notcm'],
              'cc': ['icc', 'g++']},

    'bench2': {'sizes': [['500', str(4000 * x), str(4000*c), str(x)]
                        for x in [1, 2, 4, 8, 14, 28, 56]],
              'vec': ['vec'],
              'tcm': ['notcm'],
              'cc': ['icc']},

    'bench3': {'sizes': [['500', str(4000 * x), str(4000*c), str(x)]
                        for x in [1, 2, 4, 8, 14, 28, 56]],
              'vec': ['vec', 'novec'],
              'tcm': ['notcm', 'tcm'],
              'cc': ['icc']},

    'bench5': {'sizes': [['500', str(4000 * x), str(4000*c), str(x)]
                        for x in [1, 2, 4, 8, 14, 28, 56]],
              'vec': ['vec', 'novec'],
              'tcm': ['notcm', 'tcm'],
              'cc': ['icc']},

    'bench7': {'sizes': [['500', str(4000 * x), str(4000*c), str(x)]
                        for x in [1, 2, 4, 8, 14, 28, 56]],
              'vec': ['vec', 'novec'],
              'tcm': ['notcm'],
              'cc': ['g++', 'icc']},

    'bench8': {'sizes': [['500', str(4000 * x), str(4000*c), str(x)]
                        for x in [1, 2, 4, 8, 14, 28, 56]],
              'vec': ['vec', 'novec'],
              'tcm': ['notcm', 'tcm'],
              'cc': ['icc']}
