...
configs = {
    'bench0.exe': {'sizes': [['5000', '4000000', '4000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench1.exe': {'sizes': [['5000', '4000000', '4000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench3.exe': {'sizes': [['5000', '4000000', '4000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench5.exe': {'sizes': [['5000', '4000000', '4000', str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
