...
result_dir = result_dir + 'i{}-p{}-s{}-t{}-{}-{}-{}/'
csv_dir = csv_dir + 'i{}-p{}-s{}-t{}-{}-{}-{}/'

configs = {
    'bench0.exe': {'sizes': [['1000', str(4000000*x), str(4000 * x), str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench1.exe': {'sizes': [['1000', str(4000000*x), str(4000 * x), str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench2.exe': {'sizes': [['1000', str(4000000*x), str(4000 * x), str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench4.exe': {'sizes': [['1000', str(4000000*x), str(4000 * x), str(x)]
                             for x in [1]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
