...
configs = {
    'bench0.exe': {'sizes': [['1000', str(4000000), str(x), '1']
                             for x in [1, 2, 4, 10]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['icc']
                   },
    'bench2.exe': {'sizes': [['1000', str(4000000), str(x), '1']
                             for x in [1, 2, 4, 10]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench5.exe': {'sizes': [['1000', str(4000000), str(x), '1']
                             for x in [1, 2, 4, 10]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['g++']
                   },
    'bench6.exe': {'sizes': [['1000', str(4000000), str(x), '1']
                             for x in [1, 2, 4, 10]],
                   'vec': ['vec'],
                   'tcm': ['notcm'],
                   'cc': ['icc']
